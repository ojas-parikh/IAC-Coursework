...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    CData/*7:0*/ __VdlyVal__sigdelay__DOT__audioRam__DOT__ram_array__v0;
    __VdlyVal__sigdelay__DOT__audioRam__DOT__ram_array__v0 = 0;
    SData/*8:0*/ __VdlyDim0__sigdelay__DOT__audioRam__DOT__ram_array__v0;
    __VdlyDim0__sigdelay__DOT__audioRam__DOT__ram_array__v0 = 0;
    CData/*0:0*/ __VdlySet__sigdelay__DOT__audioRam__DOT__ram_array__v0;
    __VdlySet__sigdelay__DOT__audioRam__DOT__ram_array__v0 = 0;
    // Body
    __Vdly__sigdelay__DOT__address = vlSelfRef.sigdelay__DOT__address;
    __VdlySet__sigdelay__DOT__audioRam__DOT__ram_array__v0 = 0U;
    if (vlSelfRef.rst) {
        __Vdly__sigdelay__DOT__address = 0U;
    } else if (vlSelfRef.wr) {
        __Vdly__sigdelay__DOT__address = (0x1ffU & 
                                          ((IData)(vlSelfRef.sigdelay__DOT__address) 
                                           + (IData)(vlSelfRef.incr)));
    }
    if (vlSelfRef.wr) {
        __VdlyVal__sigdelay__DOT__audioRam__DOT__ram_array__v0 
            = (0xffU & (IData)(vlSelfRef.mic_signal));
        __VdlyDim0__sigdelay__DOT__audioRam__DOT__ram_array__v0 
            = vlSelfRef.sigdelay__DOT__address;
        __VdlySet__sigdelay__DOT__audioRam__DOT__ram_array__v0 = 1U;
    }
    if (vlSelfRef.rd) {
        vlSelfRef.delayed_signal = vlSelfRef.sigdelay__DOT__audioRam__DOT__ram_array
            [(0x1ffU & ((IData)(vlSelfRef.offset) + (IData)(vlSelfRef.sigdelay__DOT__address)))];
    }
    if (__VdlySet__sigdelay__DOT__audioRam__DOT__ram_array__v0) {
        vlSelfRef.sigdelay__DOT__audioRam__DOT__ram_array[__VdlyDim0__sigdelay__DOT__audioRam__DOT__ram_array__v0] 
            = __VdlyVal__sigdelay__DOT__audioRam__DOT__ram_array__v0;
    }
    vlSelfRef.sigdelay__DOT__address = __Vdly__sigdelay__DOT__address;
}
...
void Vsigdelay___024root___eval_debug_assertions(Vsigdelay___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.mic_signal & 0xfe00U)))) {
