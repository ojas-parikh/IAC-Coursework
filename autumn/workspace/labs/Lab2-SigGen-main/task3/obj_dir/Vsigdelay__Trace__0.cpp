...
void Vsigdelay___024root__trace_chg_0_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgSData(oldp+4,(vlSelfRef.mic_signal),9);
    ...
    bufp->chgSData(oldp+8,(vlSelfRef.sigdelay__DOT__address),9);
    bufp->chgSData(oldp+9,(vlSelfRef.incr),9);
    bufp->chgSData(oldp+10,((0x1ffU & ((IData)(vlSelfRef.offset) 
                                       + (IData)(vlSelfRef.sigdelay__DOT__address)))),9);
    bufp->chgCData(oldp+11,((0xffU & (IData)(vlSelfRef.mic_signal))),8);
}
